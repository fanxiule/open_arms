#ifndef _ROS_grizzly_msgs_Status_h
#define _ROS_grizzly_msgs_Status_h
...
namespace grizzly_msgs
{
  ...
  class Status : public ros::Msg
  {
    public:
      ...
      typedef bool _external_stop_engaged_type;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset + 0) = (u_stop_engaged.base >> (8 * 0)) & 0xFF;
      ...
      union {
        bool real;
        uint8_t base;
      } u_external_stop_engaged;
      u_external_stop_engaged.real = this->external_stop_engaged;
      *(outbuffer + offset + 0) = (u_external_stop_engaged.base >> (8 * 0)) & 0xFF;
      offset += sizeof(this->external_stop_engaged);
      union {
        float real;
        uint32_t base;
      } u_measured_battery;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      u_external_stop_engaged.base = 0;
      u_external_stop_engaged.base |= ((uint8_t) (*(inbuffer + offset + 0))) << (8 * 0);
      this->external_stop_engaged = u_external_stop_engaged.real;
      offset += sizeof(this->external_stop_engaged);
      union {
        float real;
        uint32_t base;
    ...
    const char * getType(){ return "grizzly_msgs/Status"; };
    const char * getMD5(){ return "b7c26be1e34a0256ce732022c187908d"; };
